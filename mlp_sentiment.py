...
if __name__ == "__main__":
    ...
    test_dataset = sentiment_dataset(test_data, word_to_idx, max_len=max_len, ngram=ngram)
    ...
    evaluate(model,
             test_dataloader,
             os.path.join("results", f"mlp_{data_type}_{feature_type}_test_predictions.csv"), loader=True)
